...
public class NodeCameraViewManager extends ViewGroupManager<RCTNodeCameraView> {
    ...
    private static final String COMMAND_TAKEFRAMEBLACK = "takeFrameBlack";
    private static final int COMMAND_TAKEFRAMEBLACK_ID = 6;
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.of(
                ...
                COMMAND_TAKEFRAMEBLACK, COMMAND_TAKEFRAMEBLACK_ID
        );
    }
    ...
    public void receiveCommand(RCTNodeCameraView root, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
            ...
            case COMMAND_SWITCH_CAM_ID:
                root.switchCam();
                break;
            case COMMAND_TAKEFRAMEBLACK_ID:
                root.takeFrameBlack();
                break;
